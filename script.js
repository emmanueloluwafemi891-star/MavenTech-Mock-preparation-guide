...
options: [
"The single original copy of a file used for daily operations",
"A separately stored duplicate copy of data, used to restore information if the original is lost",
"A harmful program intended to damage stored files",
"A method used to permanently erase unwanted files"
],
answer: 1,
working: "A backup is a protective duplicate of data kept apart from the original, allowing recovery if the primary copy is lost."
},
{
question: "Which scenario best illustrates real-time processing in a Nigerian banking context?",
options: [
"Calculating end-of-month interest on all accounts overnight",
"Compiling an annual financial report for shareholders",
"Archiving five years of old transaction records",
"Withdrawing cash from an ATM and receiving instant confirmation and balance update"
],
answer: 3,
working: "ATM withdrawals require immediate processing and response, the defining feature of real-time processing."
},
{
question: "A company stores the same customer's name and address independently across three separate departmental files. This scenario most clearly illustrates:",
options: [
"Data redundancy, risking inconsistency if one copy is updated without the others",
"Efficient, well-structured data organization",
"A properly centralized, single-source database design",
"A demonstration of real-time processing principles"
],
answer: 0,
working: "Storing identical data in multiple disconnected files is a textbook case of data redundancy."
},
{
question: "Which scenario best demonstrates distributed processing in practice?",
options: [
"A single standalone computer with zero network connection",
"One person typing a letter on an isolated, offline computer",
"A bank's branches in different cities each processing local transactions on their own servers, linked via a shared network",
"A purely manual ledger system involving no computers"
],
answer: 2,
working: "Distributed processing involves multiple, geographically separated, interconnected computers sharing the processing workload."
},
{
question: "Why might an organization prefer indexed-sequential file organization over pure sequential organization for a large customer database?",
options: [
"It completely removes the need for any sorting",
"It enables both efficient ordered processing and faster direct access to specific records via an index",
"It is simpler to implement and needs no index structure",
"It can only be used for extremely small files"
],
answer: 1,
working: "Indexed-sequential organization offers a balance: sequential ordering for batch-style processing, plus an index for quick direct lookup."
},
{
question: "A university must process thousands of admission forms collected over a month, generating results only once after the application window closes. Which processing style fits best?",
options: [
"Real-time processing",
"Time-sharing processing",
"Strictly online processing only",
"Batch processing"
],
answer: 3,
working: "Since applications accumulate and results are needed only after the full collection period, batch processing fits this scenario best."
},
{
question: "Which scenario best demonstrates multiprogramming on a single-CPU personal computer?",
options: [
"A user having a music player, browser, and word processor all open, with the CPU rapidly switching between them",
"The CPU dedicating itself to one instruction for the entire session",
"Two entirely separate physical computers cooperating on a shared task",
"A computer that has been completely powered off"
],
answer: 0,
working: "Multiprogramming on a single CPU involves holding multiple programs in memory and switching rapidly between them."
},
{
question: "Why is timeliness considered just as critical as accuracy when evaluating data quality?",
options: [
"Timeliness has essentially no real bearing on data's usefulness",
"Timeliness is only a concern for paper-based, manual systems",
"Even highly accurate data can become useless if it arrives too late to inform a relevant decision",
"Accuracy automatically guarantees that data will also be timely"
],
answer: 2,
working: "Data that is accurate but arrives after the relevant decision has been made provides little practical value."
},
{
question: "A weekly payroll system updates a master employee file using a batch of submitted hours-worked transaction records. This scenario exemplifies:",
options: [
"Purely real-time processing with no delay",
"The typical relationship between master files and transaction files in batch-style updating",
"An example of distributed processing exclusively",
"A scenario involving no file structure at all"
],
answer: 1,
working: "This illustrates how transaction files are periodically used in batch fashion to update the more permanent master file."
},
{
question: "Which argument most strongly supports using a DBMS rather than separate flat files for a hospital's patient record system?",
options: [
"Flat files inherently offer superior data integrity than any DBMS",
"A DBMS cannot support access by more than one department simultaneously",
"A DBMS centralizes related data, minimizes redundancy, and allows controlled, consistent access across departments",
"Flat files automatically prevent any duplication of patient data"
],
answer: 2,
working: "A DBMS's centralized structure allows multiple departments to access consistent, non-redundant patient data under controlled permissions."
},
{
question: "A real-time processing approach would be LEAST appropriate for which of the following tasks?",
options: [
"Air traffic control monitoring",
"ATM cash withdrawal processing",
"Emergency medical alert systems",
"Compiling an organization's historical annual financial summary report"
],
answer: 3,
working: "Historical annual summary reports don't require instant responsiveness; they suit scheduled, periodic processing rather than real-time demands."
},
{
question: "Which statement offers the strongest critique of pure sequential file organization for a busy, interactive online store?",
options: [
"Sequential organization is ideal, since shoppers always want orders handled strictly in arrival order",
"Sequential files require no storage medium of any kind",
"Sequential organization functions identically to direct access in every scenario",
"Sequential organization's requirement to read records in order makes it poorly suited for systems needing fast, direct access to randomly requested records"
],
answer: 3,
